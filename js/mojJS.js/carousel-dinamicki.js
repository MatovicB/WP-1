...
let nizCarouselSlikaSrc = ["images/sport3.png","images/sport1.png","images/sport2.png"];
...
for(let i =0;i<nizCarouselSlikaSrc.length;i++){
    ...
    divCarouselItem.setAttribute("class", i == 0 ? "carousel-item active":"carousel-item");
